...
# @Date:   2020-06-18 11:07:33
# @Last Modified by:   Aniket Maithani
# @Last Modified time: 2020-06-18 11:28:21
import datetime
import json
...
def test_favourite_restaurant(client):
    user_obj = f.create_user(username='favourite', password='test123')
    user_obj.save()
    user_creds = {"username": "favourite", "password": "test123"}
    user_authenticate = authenticate(username='favourite', password='test123')
    ...
    restaurant_obj.save()
    url = '/api/v1/restaurant/favouriterestaurant?rid={}'.format(
        restaurant_obj.id)
